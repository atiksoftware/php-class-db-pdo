<?php
/** this model owner is Pritesh Gupta
 * i just make composer library for use psr
 * 
 * 
 ...
 * Database operations. 
 * 
 * @see https://codecanyon.net/item/pdomodel-database-abstraction-and-helper-php-class/
 * @see http://demo.digitaldreamstech.com/PDOModel/documentation/pdo/index.php
 * 
  ---------------------------------------------------------------------------------------------------------------
 */
